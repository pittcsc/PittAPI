...
from pittapi.people import PEOPLE_SEARCH_URL, REQUEST_HEADERS, PeopleClient, Person, PersonField, parse_segments
...
def test_people_search_returns_models():
    ...
    assert responses.calls[0].request.headers["User-Agent"] == REQUEST_HEADERS["User-Agent"]
